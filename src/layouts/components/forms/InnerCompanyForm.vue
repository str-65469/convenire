			...
			<b-row>
				...
				<b-col md="6">
					<b-form-group>
						...
						<validation-provider #default="{ errors }" name="ანგარიშის ნომერი" rules="required">
							<b-form-input v-model="FormData.account_number" placeholder="ანგარიშის ნომერი" />
				...
				<b-col md="6">
					<b-form-group>
						...
						<validation-provider #default="{ errors }" name="ბანკის კოდი" rules="required">
							<b-form-input v-model="FormData.bank_code" placeholder="ბანკის კოდი" />
